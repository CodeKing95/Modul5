const notesListEl = document.querySelector(".notize-liste");
const saveButtonEl = document.querySelector(".speichern-note");
const deleteButtonEl = document.querySelector(".löschen-note");
const newNoteButtonEl = document.querySelector(".create-neu");
